# Generated by Django 3.2.16 on 2023-10-23 08:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, help_text='Это поле автоматически заполнится, оставьте пустым.', max_length=10, verbose_name='Заголовок')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, help_text='Это поле автоматически заполнится, оставьте пустым.', max_length=15, verbose_name='Заголовок')),
                ('year', models.SmallIntegerField(help_text='Можно указать только текущий и следующий год. Обязательное поле.', validators=[django.core.validators.MinValueValidator(2023), django.core.validators.MaxValueValidator(2024)], verbose_name='Год')),
            ],
            options={
                'verbose_name': 'год',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month', models.ForeignKey(blank=True, help_text='Это поле автоматически заполнится, оставьте пустым.', on_delete=django.db.models.deletion.CASCADE, related_name='weeks', to='schedules.month', verbose_name='Месяц')),
            ],
            options={
                'verbose_name': 'неделя',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additionally_text', models.TextField(blank=True, help_text='Необязательное. Можно написать заметки для себя.', max_length=500, null=True, verbose_name='Заметки')),
                ('date', models.DateField(help_text='Обязательное. Выберите дату для расписания.', validators=[schedules.validators.validate_sunday], verbose_name='Дата')),
                ...
                ('author', models.ForeignKey(help_text='Обязательное. Выберите автора.', on_delete=django.db.models.deletion.CASCADE, related_name='schedules', to=settings.AUTH_USER_MODEL, verbose_name='Автор расписания')),
        ...
        migrations.AddField(
            model_name='month',
            name='year',
            field=models.ForeignKey(blank=True, help_text='Это поле автоматически заполнится, оставьте пустым.', on_delete=django.db.models.deletion.CASCADE, related_name='months', to='schedules.year', verbose_name='Год'),
        ),
